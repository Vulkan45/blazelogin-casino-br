...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-69a1dc11');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-69a1dc11');}
...
var brandEl=document.querySelector('.rl-brand-69a1dc11');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
